...
case $choice in
    1)
        ...
        docker run -d \
            ...
            -e APP_DEBUG="false" \
            -e APP_KEY="${APP_KEY:-base64:$(openssl rand -base64 32)}" \
            ...
            -e DB_PASSWORD="${DB_PASSWORD:-your_secure_password_here}" \
            -e CACHE_STORE="redis" \
            -e SESSION_DRIVER="redis" \
            -e QUEUE_CONNECTION="redis" \
            -e REDIS_HOST="MyWorkProfile-redis" \
            -e REDIS_PASSWORD="${REDIS_PASSWORD:-your_redis_password_here}" \
            -e REDIS_PORT="6379" \
